...
20:     M_NO = xlsheet.Cells(LINE_NO, 1).Value
        ...
        Else
            M_SR = M_NO
            PrintLine(1, Chr(34) + "M" + M_SR + "_In " + Chr(34) + Chr(58) + Chr(34) + "#YF#InputTransfer" + Chr(34))
            LINE_NO = LINE_NO + 1
            GoTo 20
        End If
...
40:     M_NO = xlsheet.Cells(LINE_NO, 1).Value
        ...
        Else
            ...
            'Print #1, "//"; M_SR; "输入信号映射;"
            PrintLine(1, Chr(35) + Chr(34) + "M" + M_SR + "_In" + Chr(34) + Chr(40))
...
20:     M_NO = xlsheet.Cells(LINE_NO, 1).Value
        ...
        Else
            M_SR = M_NO
            PrintLine(1, Chr(34) + "M" + M_SR + "_Out " + Chr(34) + Chr(58) + Chr(34) + "#YF#OutputTransfer" + Chr(34))
            LINE_NO = LINE_NO + 1
            GoTo 20
        End If
30:     LINE_NO = 3
40:     M_NO = xlsheet.Cells(LINE_NO, 1).Value
        ...
        Else
            ...
            'Print #1, "//"; M_SR; "输入信号映射;"
            PrintLine(1, Chr(35) + Chr(34) + "M" + M_SR + "_Out" + Chr(34) + Chr(40))
            PrintLine(1, "M_ID:=" + M_SR + ",")
            Print(1, "M_ID_Offset:=" + M_OFFSET)
            If FW <> Nothing Then
                PrintLine(1, ",")
...
201 ： M_NO = xlsheet.Cells(LINE_NO, 1).Value
        ...
        Else
            ...
            If M_1or2 = "1" Then
                ...
                End If
                If M_MorF = "5" Then
                    PrintLine(1, Chr(34) + "M" + M_SR + "_Status"":" + Chr(34) + "#YF#StatusIO" + Chr(34))
                End If
                If M_MorF = "6" Then
                    PrintLine(1, Chr(34) + "M" + M_SR + "_Status"":" + Chr(34) + "#YF#StatusIO_VF" + Chr(34))
                End If
            End If
            ...
            If M_1or2 = "2" Then
                ...
                End If
                If M2_MorF = "5" Then
                    PrintLine(1, Chr(34) + "M" + M_SR1 + "_Status"":" + Chr(34) + "#YF#StatusIO" + Chr(34))
                End If
                If M2_MorF = "6" Then
                    PrintLine(1, Chr(34) + "M" + M_SR1 + "_Status"":" + Chr(34) + "#YF#StatusIO_VF" + Chr(34))
                End If
            End If
...
20:     M_NO = xlsheet.Cells(LINE_NO, 1).Value
        ...
        Else
            ...
            If M_MorF = "1" Then
                    ...
                    PrintLine(1, Chr(35) + Chr(34) + "M" + M_SR + "_status" + Chr(34) + Chr(40))
                    PrintLine(1, "M_ID :=" + M_SR + ",")
            ...
            If M_1or2 = "2" And M2_MorF = "1" Then
                ...
                PrintLine(1, Chr(35) + Chr(34) + "M" + M_SR1 + "_status" + Chr(34) + Chr(40))
